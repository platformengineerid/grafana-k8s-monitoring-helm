...
![Version: 0.4.1](https://img.shields.io/badge/Version-0.4.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.3.7](https://img.shields.io/badge/AppVersion-1.3.7-informational?style=flat-square)
...
|------------|------|---------|
| https://grafana.github.io/helm-charts | grafana-agent | 0.27.2 |
| https://grafana.github.io/helm-charts | grafana-agent-logs(grafana-agent) | 0.27.2 |
